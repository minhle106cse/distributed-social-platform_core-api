 ...
 * service instead of copy-pasted into each one. core-api has exactly ONE
 * repos shape now, so the factory is a plain constructor dependency — no
